// ========================================
// 🇧🇫 GOOGLE SHEETS BURKINA FASO -> PAGE "APPEL"
// ========================================
// Version multi-pays du script (pour Burkina Faso uniquement)
// A coller dans le Google Sheet du Burkina Faso : Extensions -> Apps Script
//
// Différence avec le script CI :
//   - Constante COUNTRY_CODE = 'BF'
//   - Le header HTTP 'X-Country: BF' est ajouté à chaque requête
//
...
const API_TOKEN = 'COLLE_TON_TOKEN_ICI'; // JWT d'un admin/gestionnaire qui a 'BF' dans pays_autorises

// ⚠️ IMPORTANT : ce script est dédié au pays Burkina Faso.
...
function envoyerCommandeVersAPI(sheet, row, colMap) {
  ...
  // 🌐 Envoyer à l'API (avec le header X-Country pour le pays Burkina Faso)
  const options = {
    method: 'post',
